      ...
      <div className="flex flex-col gap-6 rounded-xl py-6 border-0 shadow-md bg-white dark:bg-gray-800">
        ...
        <div className="px-6 space-y-4">
          ...
          <div className="rounded-xl border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 p-6">
            ...
            <div className="space-y-4">
              <div>
                <p className="mb-2 font-bold text-gray-900 dark:text-white text-base">方法一：使用 Homebrew（推荐）</p>
                <p className="mb-2 text-sm text-gray-600 dark:text-gray-400">如果你已经安装了 Homebrew，使用它安装 Node.js 会更方便：</p>
                <CodeBlock code={`# 更新 Homebrew\nbrew update\n# 安装 Node.js\nbrew install node`} />
              </div>
              
              <div>
                <p className="mb-2 font-bold text-gray-900 dark:text-white text-base">方法二：官网下载</p>
                <ol className="ml-6 list-decimal space-y-1 text-sm text-gray-600 dark:text-gray-400">
                  <li>访问 <a href="https://nodejs.org/zh-cn/download" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Node.js 下载页面</a></li>
            ...
            <div className="mt-4 rounded-lg border border-blue-200 bg-blue-50 dark:bg-blue-950/30 p-4">
              <h6 className="mb-2 font-medium text-blue-800 dark:text-blue-300">macOS 注意事项</h6>
          ...
          <div className="rounded-lg border border-green-200 bg-green-50 dark:bg-green-950/30 p-4">
            ...
            <p className="mb-3 text-sm text-green-700 dark:text-green-400">安装完成后，打开 Terminal，输入以下命令：</p>
      ...
      <div className="flex flex-col gap-6 rounded-xl py-6 border-0 shadow-md bg-white dark:bg-gray-800">
        ...
        <div className="px-6 space-y-4">
          <div className="rounded-xl border border-green-100 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 p-6">
            ...
            <p className="mb-4 text-gray-700 dark:text-gray-300">打开 Terminal，运行以下命令：</p>
            <CodeBlock 
        ...
        <div className="px-6 space-y-4">
          ...
          <div className="rounded-xl border border-purple-100 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="mb-2 font-bold text-gray-900 dark:text-white text-base">方法二：永久设置</p>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <CodeBlock code={`echo 'export ANTHROPIC_BASE_URL="http://claudecode.sylu.cc/"' >> ~/.zshrc\necho 'export ANTHROPIC_AUTH_TOKEN="你的API密钥"' >> ~/.zshrc\nsource ~/.zshrc`} />
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">对于 bash：</p>
                    <CodeBlock code={`echo 'export ANTHROPIC_BASE_URL="http://claudecode.sylu.cc/"' >> ~/.bash_profile\necho 'export ANTHROPIC_AUTH_TOKEN="你的API密钥"' >> ~/.bash_profile\nsource ~/.bash_profile`} />
                  </div>
                </div>
              </div>
            </div>
